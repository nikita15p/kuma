...
type ProvidedCertificateAuthorityConfig struct {
	...
	// Data source for the root cert
	RootCert *v1alpha1.DataSource `protobuf:"bytes,3,opt,name=rootCert,proto3" json:"rootCert,omitempty"`
	// Data source for the chain cert
	ChainCert *v1alpha1.DataSource `protobuf:"bytes,4,opt,name=chainCert,proto3" json:"chainCert,omitempty"`
}
...
func (x *ProvidedCertificateAuthorityConfig) GetRootCert() *v1alpha1.DataSource {
	if x != nil {
		return x.RootCert
	}
	return nil
...
func (x *ProvidedCertificateAuthorityConfig) GetChainCert() *v1alpha1.DataSource {
	if x != nil {
		return x.ChainCert
	}
	return nil
...
var file_pkg_plugins_ca_provided_config_provided_ca_config_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x02, 0x0a,
	...
	0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x3c, 0x0a,
	0x08, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x65, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x65, 0x52, 0x08, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x65, 0x72, 0x74, 0x12, 0x3e, 0x0a, 0x09, 0x63,
	0x68, 0x61, 0x69, 0x6e, 0x43, 0x65, 0x72, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20,
	...
	0x52, 0x09, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x43, 0x65, 0x72, 0x74, 0x42, 0x2a, 0x5a, 0x28, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x75, 0x6d, 0x61, 0x68, 0x71,
	0x2f, 0x6b, 0x75, 0x6d, 0x61, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x63, 0x61,
...
var file_pkg_plugins_ca_provided_config_provided_ca_config_proto_depIdxs = []int32{
	...
	1, // 2: kuma.plugins.ca.ProvidedCertificateAuthorityConfig.rootCert:type_name -> kuma.system.v1alpha1.DataSource
	1, // 3: kuma.plugins.ca.ProvidedCertificateAuthorityConfig.chainCert:type_name -> kuma.system.v1alpha1.DataSource
